...
function fn_update_customization_mode(array $modes, $storefront_id = null)
{
    ...
    Settings::instance(['storefront_id' => $storefront_id])->updateValue('customization_mode', implode(',', array_keys($enabled_modes)));
 ...
 */
function fn_core_update_language_post($language_data, $lang_id, $action)
{
    if ($action == 'add') {
