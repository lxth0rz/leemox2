...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($mode === 'import') {
        ...
        if (!empty($preset)) {
            ...
            if (
                isset(Tygh::$app['session']['import_file'])
                && $current_company
                && $current_company !== $preset['company_id']
                && Tygh::$app['session']['import_file']['preset_id'] === (int) $preset['preset_id']
            ) {
                $preset['file'] = isset(Tygh::$app['session']['import_file']['file_name'])
                    ? Tygh::$app['session']['import_file']['file_name']
                    : $preset['file'];
            ...
            try {
                ...
                if ($remapping_schema) {
                    ...
                    $presets_manager->updateStatistics([
            ...
            if (isset(Tygh::$app['session']['import_file']['file_name'])) {
                ...
                if ($current_company && $preset['company_id'] !== $current_company) {
