...
class RenderManager
{
    ...
    public static function allowCache()
    {
        ...
        if (Registry::ifGet('config.tweaks.disable_block_cache', false)
            || Registry::get('runtime.customization_mode.design')
            || Registry::get('runtime.customization_mode.translation')
            || Registry::get('runtime.customization_mode.block_manager')
