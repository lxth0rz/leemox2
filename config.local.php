...
$config['db_name'] = 'lx_db2';
$config['db_user'] = 'root';
$config['db_password'] = 'rdthnbroot';
...
$config['http_host'] = 'leemox.com';
$config['http_path'] = '/demo2';

// Host and directory where software is installed on secure server
$config['https_host'] = 'leemox.com';
$config['https_path'] = '/demo2';
