...
{if isset($item.global_setting)}
    ...
    {$update_for_all_absolute_position = false}
...
{* Update for all setting *}
{$update_for_all_absolute_position = $update_for_all_absolute_position|default:true}
        ...
        <div class="controls">
            ...
            {capture name="update_for_all"}
                ...
                {include file="buttons/update_for_all.tpl"
                    ...
                    absolute_position=$update_for_all_absolute_position
