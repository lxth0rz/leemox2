        ...
        {if $field.profile_type === "ProfileTypes::CODE_SELLER"|enum || $profile_type === "ProfileTypes::CODE_SELLER"|enum}
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="checkbox" name="field_data[storefront_show]" value="{"YesNo::YES"|enum}" {if $field.storefront_show === "YesNo::YES"|enum}checked="checked"{/if} {if $field.field_name === "company"}disabled="disabled"{/if}/>
                </div>
            </div>
        {/if}
