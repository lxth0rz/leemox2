                        ...
                        >
                            ...
                            <td width="20%" data-th="{__("feature")}">
                                <div class="object-group-link-wrap">
                                    {if !$non_editable}
                                        <a {if !$show_in_popup}href="{$href_edit|fn_url}"{/if} class="row-status cm-external-click {if $non_editable} no-underline{/if}"{if !$non_editable} data-ca-external-click-id="opener_group{$p_feature.feature_id}"{/if}>{$p_feature.internal_name}</a>
                                    {else}
