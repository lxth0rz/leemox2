            ...
            <div class="table-responsive-wrapper">
                ...
                {foreach from=$reward_usergroups item=m}
                    ...
                    <tr id="container_earned_points_{$object_type}_{$m_id}">
                        ...
                        {if $show_update_for_all}
                        <td data-th="{__("tools")}">
                            {include file="buttons/update_for_all.tpl" absolute_position=false display=true name="reward_points[`$m_id`][update_all_vendors]" hide_element="earned_points_`$object_type`_`$m_id`" object_id=$m_id}
                        </td>
                        {/if}
                    </tr>
                {/foreach}
