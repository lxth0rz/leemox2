<?php /* Smarty version Smarty-3.1.21, created on 2020-12-05 23:47:24
         compiled from "/var/www/html/demo2/design/backend/templates/common/settings_fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5858710785fcbf1dce62b49-03253518%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bd512d59a42328ee3c9fad2c62a9b12f1fb87989' => 
    array (
      0 => '/var/www/html/demo2/design/backend/templates/common/settings_fields.tpl',
      1 => 1606814111,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5858710785fcbf1dce62b49-03253518',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'update_for_all_absolute_position' => 0,
    'parent_item' => 0,
  ...
  'unifunc' => 'content_5fcbf1dd2e9f44_21375968',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fcbf1dd2e9f44_21375968')) {function content_5fcbf1dd2e9f44_21375968($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include '/var/www/html/demo2/app/functions/smarty_plugins/block.inline_script.php';
if (!is_callable('smarty_modifier_enum')) include '/var/www/html/demo2/app/functions/smarty_plugins/modifier.enum.php';
if (!is_callable('smarty_modifier_in_array')) include '/var/www/html/demo2/app/functions/smarty_plugins/modifier.in_array.php';
if (!is_callable('smarty_modifier_render_tag_attrs')) include '/var/www/html/demo2/app/functions/smarty_plugins/modifier.render_tag_attrs.php';
...
<?php if (isset($_smarty_tpl->tpl_vars['item']->value['global_setting'])) {?>
    ...
    <?php $_smarty_tpl->tpl_vars['update_for_all_absolute_position'] = new Smarty_variable(false, null, 0);?>
...
<?php $_smarty_tpl->tpl_vars['update_for_all_absolute_position'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['update_for_all_absolute_position']->value)===null||$tmp==='' ? true : $tmp), null, 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <?php $_smarty_tpl->_capture_stack[0][] = array("update_for_all", null, null); ob_start(); ?>
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('display'=>$_smarty_tpl->tpl_vars['item']->value['update_for_all'],'hide_element'=>$_smarty_tpl->tpl_vars['html_id']->value,'absolute_position'=>$_smarty_tpl->tpl_vars['update_for_all_absolute_position']->value,'object_ids'=>$_smarty_tpl->tpl_vars['settings_ids']->value,'names'=>$_smarty_tpl->tpl_vars['settings_input_names']->value), 0);?>
